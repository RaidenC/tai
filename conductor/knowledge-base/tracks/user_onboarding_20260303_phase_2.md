...
*   **Asynchronous Processing:** Sending real emails/SMS during the HTTP request will drastically reduce API throughput.
    ...
    *   **Architectural Clarification: SignalR vs. Message Brokers (RabbitMQ/Cloud Native):** It is critical to understand that SignalR and RabbitMQ serve completely different purposes and are *not* alternatives to each other.
