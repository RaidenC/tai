 ...
 * 2. Concurrency-safe approval workflow using local confirmation host and ETag/xmin tokens.
...
export class UsersPage implements OnInit {
  ...
  /**
   * Opens the confirmation dialog for user approval using local confirmation host.
