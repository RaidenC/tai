      ...
      providers: [
        { provide: DialogRef, useValue: { close: fn() } },
        {
          ...
          useValue: {
            ...
            message:
              'Are you sure you want to proceed with this operation? This action may have significant system impact.',
            confirmText: 'Confirm',
            cancelText: 'Cancel',
      ...
      providers: [
        {
          ...
          useValue: {
            ...
            message:
              'This action is permanent and cannot be undone. The user will lose access immediately and all associated PII will be scheduled for purging.',
            confirmText: 'Delete Permanently',
            cancelText: 'Keep Account',
            confirmButtonClass:
              'bg-red-600 hover:bg-red-700 focus:ring-red-600/20 focus:border-red-600',
          } as ConfirmationDialogData,
        },
      ],
    }),
