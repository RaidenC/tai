...
public class ApplicationUser : IdentityUser, IMultiTenantEntity, IHasDomainEvents, IAuditableEntity {
  ...
  /// </summary>
  // We use the 'xmin' system column via this RowVersion property 
